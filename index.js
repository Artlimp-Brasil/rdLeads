...
// Procura se há contato já criado no bitrix com o mesmo ID de cliente do RD Marketing
      const retorno = await axios.get(
        `${process.env.LINK_WEBHOOK}/crm.contact.list.json?FILTER[UF_CRM_1713969606790]=${lead.id}`  
      ); 
